...
example_filename = os.path.join(data_path, 'Myel_001_spine_segmentation.nii')
scan = nib.load('Myel_001_spine_segmentation.nii')
img = scan.get_fdata(dtype=np.float32)
...
img_opengl_format.tofile("..\\src\\Data\\ct_scan.raw")